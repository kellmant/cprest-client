...
* [CpApiClass](#CpApiClass)
    ...
    * [.setToken()](#CpApiClass+setToken) ⇒ <code>apicall</code>
...
### cpApiClass.setToken() ⇒ <code>apicall</code>
...
| Param | Type |
| --- | --- |
| options.headers.ChkpSid | [<code>Api</code>](#Api) | 
